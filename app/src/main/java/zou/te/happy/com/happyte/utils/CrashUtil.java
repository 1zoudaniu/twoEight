...
public class CrashUtil {
    ...
    static {
        try {
            PackageInfo pi = Util.getApp()
                    .getPackageManager()
                    .getPackageInfo(Util.getApp().getPackageName(), 0);
            if (pi != null) {
        ...
        UNCAUGHT_EXCEPTION_HANDLER = new Thread.UncaughtExceptionHandler() {
            ...
            public void uncaughtException(final Thread t, final Throwable e) {
                ...
                if (createOrExistsFile(fullPath)) {
                    ...
                    MyLog.d("CrashUtils", "create " + fullPath + " failed!");
                }
    ...
    public static void init(final String crashDirPath, final OnCrashListener onCrashListener) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && Util.getApp().getExternalCacheDir() != null)
            defaultDir = Util.getApp().getExternalCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        else {
            defaultDir = Util.getApp().getCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        }
    ...
    private static void input2File(final String input, final String filePath) {
        ...
        MyLog.d("CrashUtils", "write crash info to " + filePath + " failed!");
    }
